...
var PersianNumberPipe = (function () {
    ...
    PersianNumberPipe.prototype.transform = function (value, isPersian) {
        if (!isPersian)
            return value;
        return index_1.MdsDatetimePickerUtility.toPersianNumber(value);
    };
    PersianNumberPipe = __decorate([
        core_1.Pipe({ name: 'persianNumber' })
    ], PersianNumberPipe);
